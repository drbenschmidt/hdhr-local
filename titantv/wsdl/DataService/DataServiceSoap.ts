...
export interface IRegisterUserAddressOutput {
    RegisterUserAddressResult: DataServiceSoapTypes.IRegisterUserAddressResult;
}
...
export interface IRegisterUserZipOutput {
    RegisterUserZipResult: DataServiceSoapTypes.IRegisterUserZipResult;
}
...
export interface IRequestProgramDataOutput {
    RequestProgramDataResult: DataServiceSoapTypes.IRequestProgramDataResult;
}
...
export interface IRequestProgramData2Output {
    RequestProgramData2Result: DataServiceSoapTypes.IRequestProgramData2Result;
}
...
export interface IRequestLineupDataOutput {
    RequestLineupDataResult: DataServiceSoapTypes.IRequestLineupDataResult;
}
...
export interface IRequestProvidersZipOutput {
    RequestProvidersZipResult: DataServiceSoapTypes.IRequestProvidersZipResult;
}
...
export interface IRequestLineupData2Output {
    RequestLineupData2Result: DataServiceSoapTypes.IRequestLineupData2Result;
}

export interface ITestRegisterUserHouseholdInput {}

export interface ITestRegisterUserHouseholdOutput {
    TestRegisterUserHouseholdResult: DataServiceSoapTypes.ITestRegisterUserHouseholdResult;
}

export interface ITestRegisterUserZipInput {}

export interface ITestRegisterUserZipOutput {
    TestRegisterUserZipResult: DataServiceSoapTypes.ITestRegisterUserZipResult;
}
...
export interface ITestRequestProgramDataHouseholdLevelOutput {
    TestRequestProgramDataHouseholdLevelResult: DataServiceSoapTypes.ITestRequestProgramDataHouseholdLevelResult;
}
...
export interface ITestRequestLineupDataZipLevelOutput {
    TestRequestLineupDataZipLevelResult: DataServiceSoapTypes.ITestRequestLineupDataZipLevelResult;
}
...
export interface ITestRequestProgramDataZipLevelOutput {
    TestRequestProgramDataZipLevelResult: DataServiceSoapTypes.ITestRequestProgramDataZipLevelResult;
}

export interface IDataServiceSoapSoap {
...
export namespace DataServiceSoapTypes {
    ...
    export interface IRegisterUserAddressResult {
        ...
        Provider: DataServiceSoapTypes.IProvider[];
    }
    ...
    export interface IStations {
        Station: DataServiceSoapTypes.IStation[];
    }
    ...
    export interface IProgram {
        ...
        /** http://www.titantv.com/services/dataservice#s:string(undefined) */
        language: string;
        Actors: DataServiceSoapTypes.IActors;
        /** http://www.titantv.com/services/dataservice#s:string(undefined) */
        director: string;
    }
    export interface IPrograms {
        Program: DataServiceSoapTypes.IProgram[];
    }
    ...
    export interface ISchedules {
        Schedule: DataServiceSoapTypes.ISchedule[];
    }
    export interface IProgramData {
        ...
        /** http://www.titantv.com/services/dataservice#s:int(undefined) */
        ProgramCount: number;
        Stations: DataServiceSoapTypes.IStations;
        Programs: DataServiceSoapTypes.IPrograms;
        Schedules: DataServiceSoapTypes.ISchedules;
    }
    export interface IRequestProgramDataResult {
        ...
        /** http://www.titantv.com/services/dataservice#s:string(undefined) */
        ErrorDescription: string;
        ProgramData: DataServiceSoapTypes.IProgramData[];
    }
